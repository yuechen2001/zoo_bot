...
_HELP_SECTIONS = {
    ...
    "store": (
        ...
        "*Consumable items:*\n"
        "🍖 Mega Feed (30 🪙) — restore one animal to full hunger\n"
        "⚡ Breed Boost (80 🪙) — cut active breed time by 2h\n"
        "🚀 Breed Accelerator (100 🪙) — halve remaining breed time\n"
        "🐣 Instant Hatch (500 🪙) — complete your active breed immediately\n"
        "💰 Income Boost (250 🪙) — double enclosure income for 4h\n"
        "📜 Quest Task Skip (1500 🪙) — skip one task in your active chapter\n"
        "🎯 Lucky Token (80 🪙) — 2× catch rate on next /catch\n"
        "🛡️ Streak Shield (150 🪙) — absorb one streak-breaking miss\n"
        "🧲 Rare Magnet (100 🪙) — guarantee rare-or-higher encounter\n"
        "💜 Epic Magnet (300 🪙) — guarantee epic-or-higher encounter\n"
        "✨ Mood Booster (60 🪙) — double coins on next mood check-in\n"
        "🪤 Catch Net (600 🪙) — guarantee a legendary catch\n\n"
        "💡 Habitat lures are optional — use one during /catch for 1.5× catch rate and habitat filter.\n"
        "💡 Quest Task Skip is capped at 1 skip per chapter — at least one task must be earned naturally."
    ),
    "coins": (
